...
public class PuzzlePanelInstantiator : MonoBehaviour {
	...
	void Start () {
		if (SaveData.control.cubeTex.width > SaveData.control.cubeTex.height) {
			Object.Instantiate (PuzzlePanelPrefabs [0], PuzzleCanvas.transform, false);
		} else if (SaveData.control.cubeTex.width < SaveData.control.cubeTex.height) {
			Object.Instantiate (PuzzlePanelPrefabs [1], PuzzleCanvas.transform, false);
		} else {
			Object.Instantiate (PuzzlePanelPrefabs [2], PuzzleCanvas.transform, false);
		}
	}
